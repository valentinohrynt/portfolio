  ...
  <section className="border-b border-white/5 py-20 sm:py-24">
    <div className="mx-auto max-w-6xl px-5 sm:px-6">
      <div className="mb-10 max-w-3xl">
        <p className="mb-3 text-sm font-medium tracking-wide text-sky-300/85">What I work on</p>
        <h2 className="text-3xl font-semibold tracking-tight text-slate-100 sm:text-4xl">From application flow to working software</h2>
      </div>
