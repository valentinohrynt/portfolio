      ...
      <div className="site-content">
        <header className="sticky top-0 z-50 border-b border-white/5 bg-black/72 backdrop-blur-2xl">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-6">
            ...
            <button type="button" onClick={() => setMenuOpen((value) => !value)} className="rounded-xl border border-white/10 bg-white/[0.035] p-2 text-slate-300 transition hover:bg-white/[0.06] md:hidden" aria-label="Toggle navigation">
          ...
          <section className="border-b border-white/5 py-16 sm:py-20">
            <div className="mx-auto grid max-w-6xl gap-10 px-5 sm:px-6 lg:grid-cols-[0.75fr_1.25fr]">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-100">A little about how I work</h2>
              </div>
            ...
            <div className="mx-auto max-w-6xl px-5 sm:px-6">
              <div className="glass-panel max-w-4xl rounded-3xl p-7 sm:p-10">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <a href="mailto:hariyantovalentino@gmail.com" className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.07] px-4 py-2.5 text-sm font-semibold text-slate-100 transition hover:-translate-y-0.5 hover:bg-white/[0.1]"><Mail size={16} /> Email</a>
